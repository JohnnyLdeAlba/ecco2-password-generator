    ...
    word_offset) 
{
    ...
    {
        character_id = get_character_id(cmp, ps.string.charAt(offset + index));
    ...
    line_index)
{
    ...
    if (cmp.line[line_index].id == -5)
        ps.position_x = 0;
    else if (cmp.line[line_index].id == -6)
        ps.position_x = cfg.IMAGE_WIDTH - cmp.line[line_index].w;
    else // (cmp.line[line_index] == -4)
